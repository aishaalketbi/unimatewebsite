...
const Dashboard = () => {
    ...
    const getMajorFilteredUsers = async () => {
        try {
            const response = await axios.get('https://unimatewebsitefinal-ad8eb52132df.herokuapp.com/majored-users', {
                params: {
    ...
    const getEthnicityFilteredUsers = async () => {
        try {
            const response = await axios.get('https://unimatewebsitefinal-ad8eb52132df.herokuapp.com/ethnicity-users', {
                params: {
